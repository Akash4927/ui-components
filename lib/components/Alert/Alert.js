...
function Alert(props) {
  ...
  var onClose = props.onClose,
      otherProps = _objectWithoutProperties(props, ["onClose"]);

  return _react.default.createElement(StyledAlert, otherProps, _react.default.createElement(Content, null, title && _react.default.createElement(Title, null, icon && _react.default.createElement(Icon, {
