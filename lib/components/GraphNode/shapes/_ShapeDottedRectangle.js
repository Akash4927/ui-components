...
var ShapeDottedRectangle =
/*#__PURE__*/
function (_React$Component) {
  _inherits(ShapeDottedRectangle, _React$Component);

  function ShapeDottedRectangle() {
    _classCallCheck(this, ShapeDottedRectangle);

    return _possibleConstructorReturn(this, _getPrototypeOf(ShapeDottedRectangle).apply(this, arguments));
  }

  _createClass(ShapeDottedRectangle, [{
    key: "render",
  ...
  return ShapeDottedRectangle;
}(_react.default.Component);

exports.default = ShapeDottedRectangle;